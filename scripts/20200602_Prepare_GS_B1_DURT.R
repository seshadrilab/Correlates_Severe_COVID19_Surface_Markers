...
# Read in Batch 1 workspace and prepare GatingSet. (Second version of workspace)

date <- 20200602

xml_path_b1 <- here::here("data/20200527 HAARVI DURT B1/20200527 HAARVI B1 CS2.xml")
...
save_gs(gs_b1, here::here("out/GatingSets/20200602_HAARVI_DURT_GatingSet_B1"))

#####################################################################

# gs_b1 <- load_gs(here::here("out/GatingSets/20200602_HAARVI_DURT_GatingSet_B1"))
